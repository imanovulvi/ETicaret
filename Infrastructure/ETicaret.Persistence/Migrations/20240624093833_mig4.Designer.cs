...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaret.Domen.Entitys.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETicaret.Domen.Entitys.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETicaret.Domen.Entitys.AppUsersAppRole", b =>
                {
            ...
            modelBuilder.Entity("ETicaret.Domen.Entitys.AppUsersAppRole", b =>
                {
                    b.HasOne("ETicaret.Domen.Entitys.AppRole", "AppRole")
                        .WithMany("AppUsersAppRoles")
                        .HasForeignKey("AppRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ETicaret.Domen.Entitys.AppUser", "AppUser")
                        .WithMany("AppUsersAppRoles")
